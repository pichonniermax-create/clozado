...
export const immobilier = {
  ...
  final: {
    ...
    texte:
      "La démonstration est ouverte en lecture seule, sans inscription : sept mois d’historique — dossiers, partages, commissions, relances et indicateurs. Pour en parler, réservez un créneau de trente minutes.",
  },
